...
public class Livro {
    ...
    private com.bibliotecaAtv.biblioteca.domains.Autor autor;

    @ManyToOne
    @JoinColumn(name="ideditora")
    private com.bibliotecaAtv.biblioteca.domains.Editora editora;
    ...
    public Livro(long idLivro, String titulo, String isbn, int numeroPaginas, LocalDate dataCompra, BigDecimal valorCompra, com.bibliotecaAtv.biblioteca.domains.Autor autor, com.bibliotecaAtv.biblioteca.domains.Editora editora, Status status, Conservacao conservacao) {
    ...
    public com.bibliotecaAtv.biblioteca.domains.Autor getAutor() {
        return autor;
    }

    public void setAutor(com.bibliotecaAtv.biblioteca.domains.Autor autor) {
        this.autor = autor;
    }

    public com.bibliotecaAtv.biblioteca.domains.Editora getEditora() {
        return editora;
    }

    public void setEditora(com.bibliotecaAtv.biblioteca.domains.Editora editora) {
        this.editora = editora;
    }
